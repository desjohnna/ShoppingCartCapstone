...
/* LEARNED HOW TO USE A BIG DECIMAL DATA TYPE IN CONSTRUCTOR */
    ...
    @Before
    public void setUp() {
        product1 = new Products(1, "Title1", b1, true, "books", "test-tes.com");
        product2 = new Products(2, "Title2", b2, true, "books", "test-tes.com");
        product3 = new Products(3, "Title3", b3, true, "books", "test-tes.com");
    ...
    public void testMoviesFromMovieList() {
        ...
        when(movieRepoMock.getUserMovieList(1)).thenReturn(productsList);
        assertEquals(expectedList, productsService.searchMyMovie(1, "Jur"));
    }
